...
public class BusHomePage {
	...
	private WebElement pkg_departure;
	...
	//@FindBy(className="//*[@class='search-btn search-journey']")
	...
	public void searchOneWayTrip(String from,String to,String deptDate) {
		...
		//System.out.println("Source sleected");
		
		//testing
		//WebElement e = driver.findElement(By.className("ui-menu-item"));
		dest.clear();
		dest.sendKeys(to);
		...
		System.out.println("Destination sleected");
	...
	public void searchRoundTrip(String from,String to,String deptDate,String retDate) {
	    ...
	    searchJourney.click();
		//System.out.println("Cilcking is fine");
	}
